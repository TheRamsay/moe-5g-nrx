...
echo "Dense small/mid finalization v1"
...
build_args() {
  ...
  local args=(
    ...
    "experiment.batch_name=dense-small-mid-finalization-v1"
    "experiment.exp_name=$exp_name"
    "experiment.study_slug=2026-04-05-dense-small-mid-finalization-v1"
    "experiment.study_path=experiments/2026-04-05-dense-small-mid-finalization-v1"
    "experiment.question=finalize_small_mid_dense_20k_for_moe_warmstart"
  )
  printf '%s ' "${args[@]}"
}
...
submit_variant "exp03_dense_capacity_small" "dense_small_final20k_constant_lr_s67"
submit_variant "exp04_dense_capacity_mid"   "dense_mid_final20k_constant_lr_s67"
