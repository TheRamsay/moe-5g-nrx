...
echo "Dense large s32 finalization v1"
...
build_args() {
  local args=(
    "experiment=exp13_dense_large_s32_final20k"
    ...
    "experiment.batch_name=dense-large-s32-finalization-v1"
    "experiment.exp_name=dense_large_s32_final20k_constant_lr_s67"
    "experiment.study_slug=2026-04-06-dense-large-s32-finalization-v1"
    "experiment.study_path=experiments/2026-04-06-dense-large-s32-finalization-v1"
    "experiment.question=large_s32_warm_start_for_redesigned_moe"
  )
  printf '%s ' "${args[@]}"
}
...
case "$MODE" in
  ...
  local)
    ...
    ;;
  qsub)
    echo ">>> Submitting dense_large_s32_final20k_constant_lr_s67"
