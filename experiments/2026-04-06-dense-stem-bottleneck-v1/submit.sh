...
build_args() {
  ...
  local args=(
    ...
    "experiment.batch_name=dense-stem-bottleneck-v1"
    "experiment.exp_name=$exp_name"
    "experiment.study_slug=2026-04-06-dense-stem-bottleneck-v1"
    "experiment.study_path=experiments/2026-04-06-dense-stem-bottleneck-v1"
    "experiment.question=stem_bottleneck_state_dim_ablation"
  )
  printf '%s ' "${args[@]}"
}
...
submit_variant "exp09_dense_stem_s32" "dense_stem_s32_b8_h64_lr1e3_s67"
submit_variant "exp10_dense_stem_s16" "dense_stem_s16_b8_h64_lr1e3_s67"
